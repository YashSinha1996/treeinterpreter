...
def _is_node_positive(thresholds, parents_id, positive_threshold=0):
    thres_val = thresholds[parents_id]
    return thres_val > positive_threshold
...
def _predict_tree(model, X, joint_contribution=False, positive_threshold=None):
    ...
    take_positives = (positive_threshold is not None)
...
def _predict_forest(model, X, joint_contribution=False, positive_threshold=None):
    """
...
def predict(model, X, joint_contribution=False, positive_threshold=None):
